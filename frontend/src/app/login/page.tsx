      ...
      <div className="max-w-md w-full bg-white p-8 rounded-3xl border border-gray-100 shadow-2xl">
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <button 
            disabled={loading}
            type="submit" 
            className="w-full bg-[#181818] text-white py-3 rounded-full font-bold shadow-md hover:bg-black transition flex justify-center disabled:opacity-50"
          >
        ...
        <p className="text-center text-sm text-[#5E5E5E] mt-8 font-medium">
          Don't have an account? <Link href="/signup" className="text-[#FF5623] hover:underline">Sign up</Link>
        </p>
